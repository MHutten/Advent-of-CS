...
public class ProbablyaFireHazardTest : TestSuite {
    ...
    public static void test__turn_on__good_weather__0_0_trough_999_999() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            for (int j = 0; j < 1000; j++) {
                asserts.assert_true(lights.get_light_state(i, j));
            }
    ...
    public static void test__toggle__good_weather__0_0_trough_999_0() {
        ...
        for (int index = 0; index < 1000; index++) {
            ...
            if (index % 2 == 0) {
                lights.set_light_state(index, 0, true);
            }
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            if (i % 2 == 0) {
                asserts.assert_false(lights.get_light_state(i, 0));
            } else {
                asserts.assert_true(lights.get_light_state(i, 0));
            }

            for (int j = 1; j < 1000; j++) {
                asserts.assert_false(lights.get_light_state(i, j));
            }
    ...
    public static void test__turn_on_ancient_nordic_elvish__good_weather__0_0_trough_0_0() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            for (int j = 0; j < 1000; j++) {
                ...
                if (i == 0 && j == 0) {
                    asserts.assert_equal(lights.get_light_brightness(i, j), 1);
                } else {
                    asserts.assert_equal(lights.get_light_brightness(i, j), 0);
                }
    ...
    public static void test__toggle_ancient_nordic_elvish__good_weather__0_0_trough_999_999() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            for (int j = 0; j < 1000; j++) {
                asserts.assert_equal(lights.get_light_brightness(i, j), 2);
            }
    ...
    static void Main(string[] args){
        new ProbablyaFireHazardTest().run();
    }
